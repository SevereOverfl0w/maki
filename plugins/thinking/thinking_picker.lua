...
--
-- Nothing in this file asks the host for anything beyond key names. It takes a
-- model table in and answers with lines and an action, which is what lets the
-- spec drive it with plain tables. `thinking_window.lua` owns the window and
-- the round-trips.
--
